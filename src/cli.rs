...
pub fn init() -> App<'static, 'static> {
    App::new("kitty")
        ...
        .subcommand(SubCommand::with_name("test")
          ...
          // FIXME: Very duplicated from the above test command
          .subcommand(SubCommand::with_name("watch")
                    .about("Runs a solution through the official test cases every time the source file changes. Takes the same arguments as the test command.")
                    .setting(AppSettings::DisableVersion)
                    .arg(Arg::with_name("PATH")
                         .help("Path to problem directory")
                         .default_value(".")
